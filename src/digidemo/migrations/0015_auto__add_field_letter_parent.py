...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'digidemo_letter', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['digidemo.Letter']),
                      keep_default=False)
    ...
    models = {
        ...
        u'digidemo.letter': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Letter']"}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Proposal']"}),
