...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Letter.parent_letter'
        db.add_column(u'digidemo_letter', 'parent_letter',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Letter.parent_letter'
        db.delete_column(u'digidemo_letter', 'parent_letter_id')
