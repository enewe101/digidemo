...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Letter.parent'
        db.delete_column(u'digidemo_letter', 'parent_id')

        # Adding field 'Letter.parent_id'
        db.add_column(u'digidemo_letter', 'parent_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digidemo.Letter'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Letter.parent'
        db.add_column(u'digidemo_letter', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digidemo.Letter'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Letter.parent_id'
        db.delete_column(u'digidemo_letter', 'parent_id_id')
    ...
    models = {
        ...
        u'digidemo.letter': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Letter']", 'null': 'True', 'blank': 'True'}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Proposal']"}),
