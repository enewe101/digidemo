...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Letter.parent'
        db.alter_column(u'digidemo_letter', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digidemo.Letter'], null=True))

    def backwards(self, orm):

        # Changing field 'Letter.parent'
        db.alter_column(u'digidemo_letter', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Letter']))
    ...
    models = {
        ...
        u'digidemo.letter': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Letter']", 'null': 'True', 'blank': 'True'}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Proposal']"}),
