...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.proposal'
        db.add_column(u'digidemo_discussion', 'proposal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Proposal']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.proposal'
        db.delete_column(u'digidemo_discussion', 'proposal_id')
