...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.creation_date'
        db.add_column(u'digidemo_user', 'creation_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default='2000-01-01', blank=True),
                      keep_default=False)

        # Adding field 'User.last_logged_in'
        db.add_column(u'digidemo_user', 'last_logged_in',
                      self.gf('django.db.models.fields.DateField')(default='2000-01-01'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.creation_date'
        db.delete_column(u'digidemo_user', 'creation_date')

        # Deleting field 'User.last_logged_in'
        db.delete_column(u'digidemo_user', 'last_logged_in')
    ...
    models = {
        ...
        u'digidemo.user': {
            ...
            'fname': ('django.db.models.fields.CharField', [], {'max_length': '48'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_logged_in': ('django.db.models.fields.DateField', [], {}),
            'lname': ('django.db.models.fields.CharField', [], {'max_length': '48'}),
