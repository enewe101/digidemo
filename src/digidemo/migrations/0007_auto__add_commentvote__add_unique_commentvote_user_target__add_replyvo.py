...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'digidemo_proposalvote', ['proposal_id', 'user_id'])
        ...
        db.create_table(u'digidemo_commentvote', (
            ...
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment', null=True, to=orm['digidemo.Comment'])),
        ))
        ...
        db.create_table(u'digidemo_replyvote', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('valence', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reply', null=True, to=orm['digidemo.Reply'])),
        ))
        ...
        # Adding field 'ProposalVote.target'
        db.add_column(u'digidemo_proposalvote', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='proposal', null=True, to=orm['digidemo.Proposal']),
                      keep_default=False)

        # Adding unique constraint on 'ProposalVote', fields ['user', 'target']
        db.create_unique(u'digidemo_proposalvote', ['user_id', 'target_id'])

        # Adding field 'LetterVote.target'
        db.add_column(u'digidemo_lettervote', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='voted_letter', null=True, to=orm['digidemo.Letter']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProposalVote.target'
        db.delete_column(u'digidemo_proposalvote', 'target_id')

        # Adding unique constraint on 'ProposalVote', fields ['proposal', 'user']
        db.create_unique(u'digidemo_proposalvote', ['proposal_id', 'user_id'])

        # Deleting field 'LetterVote.target'
        db.delete_column(u'digidemo_lettervote', 'target_id')
    ...
    models = {
        ...
        u'digidemo.lettervote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'letter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Letter']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voted_letter'", 'null': 'True', 'to': u"orm['digidemo.Letter']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'valence': ('django.db.models.fields.SmallIntegerField', [], {})
        },
        ...
        u'digidemo.proposalvote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Proposal']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'proposal'", 'null': 'True', 'to': u"orm['digidemo.Proposal']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'valence': ('django.db.models.fields.SmallIntegerField', [], {})
        },
        u'digidemo.reply': {
