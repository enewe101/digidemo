...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'digidemo_position', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Prime minister of Canada', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Position.name'
        db.delete_column(u'digidemo_position', 'name')
