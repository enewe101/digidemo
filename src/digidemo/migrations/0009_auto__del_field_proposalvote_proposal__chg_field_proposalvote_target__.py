...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProposalVote.proposal'
        db.delete_column(u'digidemo_proposalvote', 'proposal_id')


        # Changing field 'ProposalVote.target'
        db.alter_column(u'digidemo_proposalvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Proposal']))
        # Deleting field 'LetterVote.letter'
        db.delete_column(u'digidemo_lettervote', 'letter_id')


        # Changing field 'LetterVote.target'
        db.alter_column(u'digidemo_lettervote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Letter']))

    def backwards(self, orm):
        # Adding field 'ProposalVote.proposal'
        db.add_column(u'digidemo_proposalvote', 'proposal',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Proposal']),
                      keep_default=False)


        # Changing field 'ProposalVote.target'
        db.alter_column(u'digidemo_proposalvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digidemo.Proposal']))
        # Adding field 'LetterVote.letter'
        db.add_column(u'digidemo_lettervote', 'letter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Letter']),
                      keep_default=False)


        # Changing field 'LetterVote.target'
        db.alter_column(u'digidemo_lettervote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digidemo.Letter']))
