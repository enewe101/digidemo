...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Proposal.author'
        db.delete_column(u'digidemo_proposal', 'author_id')


        # Changing field 'Proposal.user'
        db.alter_column(u'digidemo_proposal', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
        # Deleting field 'Letter.sender'
        db.delete_column(u'digidemo_letter', 'sender_id')


        # Changing field 'Letter.user'
        db.alter_column(u'digidemo_letter', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'ReplyVote.target'
        db.alter_column(u'digidemo_replyvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Reply']))

        # Changing field 'CommentVote.target'
        db.alter_column(u'digidemo_commentvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Comment']))
        # Deleting field 'Comment.author'
        db.delete_column(u'digidemo_comment', 'author_id')


        # Changing field 'Comment.user'
        db.alter_column(u'digidemo_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):
        # Adding field 'Proposal.author'
        db.add_column(u'digidemo_proposal', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='foo', to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Proposal.user'
        db.alter_column(u'digidemo_proposal', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'Letter.sender'
        db.add_column(u'digidemo_letter', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Letter.user'
        db.alter_column(u'digidemo_letter', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ReplyVote.target'
        db.alter_column(u'digidemo_replyvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digidemo.Reply']))

        # Changing field 'CommentVote.target'
        db.alter_column(u'digidemo_commentvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['digidemo.Comment']))
        # Adding field 'Comment.author'
        db.add_column(u'digidemo_comment', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Comment.user'
        db.alter_column(u'digidemo_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
