...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DiscussionVote.discussion'
        db.delete_column(u'digidemo_discussionvote', 'discussion_id')


        # Changing field 'DiscussionVote.target'
        db.alter_column(u'digidemo_discussionvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['digidemo.Discussion']))

    def backwards(self, orm):
        # Adding field 'DiscussionVote.discussion'
        db.add_column(u'digidemo_discussionvote', 'discussion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='discussion', to=orm['digidemo.Discussion']),
                      keep_default=False)


        # Changing field 'DiscussionVote.target'
        db.alter_column(u'digidemo_discussionvote', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digidemo.Discussion'], null=True))
