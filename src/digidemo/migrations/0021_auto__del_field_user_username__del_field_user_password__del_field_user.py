...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'digidemo_user', 'password')

        # Deleting field 'User.lname'
        db.delete_column(u'digidemo_user', 'lname')

        # Deleting field 'User.fname'
        db.delete_column(u'digidemo_user', 'fname')

        # Deleting field 'User.email'
        db.delete_column(u'digidemo_user', 'email')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'digidemo_user', 'password',
                      self.gf('django.db.models.fields.CharField')(default=3, max_length=20),
                      keep_default=False)

        # Adding field 'User.lname'
        db.add_column(u'digidemo_user', 'lname',
                      self.gf('django.db.models.fields.CharField')(default=3, max_length=48),
                      keep_default=False)

        # Adding field 'User.fname'
        db.add_column(u'digidemo_user', 'fname',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=48),
                      keep_default=False)

        # Adding field 'User.email'
        db.add_column(u'digidemo_user', 'email',
                      self.gf('django.db.models.fields.EmailField')(default=datetime.datetime(2014, 6, 27, 0, 0), max_length=254),
                      keep_default=False)
