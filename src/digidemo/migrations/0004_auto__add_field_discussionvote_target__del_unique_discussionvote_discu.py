...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DiscussionVote', fields ['discussion', 'user']
        db.delete_unique(u'digidemo_discussionvote', ['discussion_id', 'user_id'])

        # Adding field 'DiscussionVote.target'
        db.add_column(u'digidemo_discussionvote', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['digidemo.Discussion'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DiscussionVote.target'
        db.delete_column(u'digidemo_discussionvote', 'target_id')

        # Adding unique constraint on 'DiscussionVote', fields ['discussion', 'user']
        db.create_unique(u'digidemo_discussionvote', ['discussion_id', 'user_id'])
    ...
    models = {
        ...
        u'digidemo.discussionvote': {
            ...
            'discussion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'discussion'", 'to': u"orm['digidemo.Discussion']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['digidemo.Discussion']", 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
