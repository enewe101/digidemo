...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DiscussionVote', fields ['user', 'discussion']
        db.create_unique(u'digidemo_discussionvote', ['user_id', 'discussion_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DiscussionVote', fields ['user', 'discussion']
        db.delete_unique(u'digidemo_discussionvote', ['user_id', 'discussion_id'])
    ...
    models = {
        ...
        u'digidemo.discussionvote': {
            'Meta': {'unique_together': "(('user', 'discussion'),)", 'object_name': 'DiscussionVote'},
