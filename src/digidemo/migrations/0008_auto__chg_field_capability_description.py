...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Capability.description'
        db.alter_column(u'digidemo_capability', 'description', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Capability.description'
        db.alter_column(u'digidemo_capability', 'description', self.gf('django.db.models.fields.CharField')(max_length=256))
