...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$HTO8LpwBPvs1$lu8lf8rkBse7wfh1hANWorw5cw1Goljzhr6eagjj3Fg=','2014-06-15 03:38:24',1,'enewe101','','','edward.newell@gmail.com',1,1,'2014-06-15 03:38:24');
...
CREATE TABLE `digidemo_comment` (
  ...
  CONSTRAINT `author_id_refs_id_08e2bc61` FOREIGN KEY (`author_id`) REFERENCES `digidemo_user` (`id`),
...
INSERT INTO `digidemo_comment` VALUES (1,1,1,'@nishanth1991 I agree with you but I think that you should consider offering some concrete evidence for what you are saying -- back up how the environmental losses will arise and why they are certain.  There\'s plenty of facts in the issue \nwiki to choose from.',1);
...
CREATE TABLE `digidemo_letter` (
  ...
  CONSTRAINT `sender_id_refs_id_f4c594b3` FOREIGN KEY (`sender_id`) REFERENCES `digidemo_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `digidemo_letter` VALUES (1,2,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',2,1,-1);
...
INSERT INTO `digidemo_letter_recipients` VALUES (1,1,1);
...
CREATE TABLE `digidemo_letter_resenders` (
  ...
  CONSTRAINT `user_id_refs_id_741cbbc6` FOREIGN KEY (`user_id`) REFERENCES `digidemo_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `digidemo_position` VALUES (1,1,1,317574.00,'613-992-4211','stephen.harper@parl.gc.ca','','Prime minister of Canada');
...
CREATE TABLE `digidemo_proposal` (
  ...
  CONSTRAINT `author_id_refs_id_8b62c78a` FOREIGN KEY (`author_id`) REFERENCES `digidemo_user` (`id`)
...
INSERT INTO `digidemo_proposal_sector` VALUES (1,1,1),(2,1,2);
...
INSERT INTO `digidemo_sector` VALUES (1,'ECO','economy'),(2,'ENV','environment'),(3,'HEA','health'),(4,'EDU','education'),(5,'IR','international relations'),(6,'SOC','society and culture'),(7,'SEC','security and readiness'),(8,'DEM','democratic mechanisms');
/*!40000 ALTER TABLE `digidemo_sector` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `digidemo_user`
--

DROP TABLE IF EXISTS `digidemo_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `digidemo_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(254) NOT NULL,
...
--
-- Dumping data for table `digidemo_user`
--

LOCK TABLES `digidemo_user` WRITE;
/*!40000 ALTER TABLE `digidemo_user` DISABLE KEYS */;
INSERT INTO `digidemo_user` VALUES (1,'edward.newell@gmail.com',1,'avatar.jpg','enewe101','Edward','Newell','4824 rue de la roche','H2J3J7','CAN','QC',0),(2,'nishanthg1991@gmail.com',1,'nishanth.jpg','nishanth1991','Nishanth','Gowda','42 rue st denis','H2H2H2','CAN','QC',0);
/*!40000 ALTER TABLE `digidemo_user` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-06-20 19:51:30
