...
REPLACE INTO `digidemo_discussion` VALUES (1,1,'Social Factors','I think that we need more material covering the social factors of this proposal.  There is only a brief mention of the displacement of people.  It would be better to get some statistics together on how many people are likely to be displaced, and how this w',3,1,127,'2014-06-30','0000-00-00');
...
REPLACE INTO `digidemo_letter` VALUES (1,2,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',2,1,-1,NULL);
...
REPLACE INTO `digidemo_letter_recipients` VALUES (1,1,1);
...
REPLACE INTO `digidemo_position` VALUES (1,1,1,317574.00,'613-992-4211','stephen.harper@parl.gc.ca','','Prime minister of Canada');
...
REPLACE INTO `digidemo_proposal_sector` VALUES (1,1,1),(2,1,2);
...
REPLACE INTO `digidemo_proposalvote` VALUES (1,1,1,0);
...
REPLACE INTO `digidemo_sector` VALUES (1,'ECO','economy'),(2,'ENV','environment'),(3,'HEA','health'),(4,'EDU','education'),(5,'IR','international relations'),(6,'SOC','society and culture'),(7,'SEC','security and readiness'),(8,'DEM','democratic mechanisms');
...
REPLACE INTO `digidemo_userprofile` VALUES (1,1,1,'avatars/superuser.jpg',4,'Somewhere','560072','India','Karnatka'),(2,2,1,'avatars/regularuser.jpg',12,'56 Long Ave.','51515','CAN','QC');
...
-- Dump completed on 2014-07-01  2:40:14
