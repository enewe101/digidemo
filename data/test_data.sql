...
REPLACE INTO `digidemo_letter` (`id`, `sender_id`, `body`, `score`, `proposal_id`, `valence`, `parent_letter_id`) VALUES (1,2,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',2,1,-1,NULL);
...
REPLACE INTO `digidemo_position` (`id`, `person_id`, `organization_id`, `salary`, `telephone`, `email`, `mandate_summary`, `name`) VALUES (1,1,1,317574.00,'613-992-4211','stephen.harper@parl.gc.ca','','Prime minister of Canada');
...
-- Dump completed on 2014-07-02 20:27:10
