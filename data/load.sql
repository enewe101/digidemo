...
REPLACE INTO `digidemo_letter` (`id`, `creation_date`, `last_modified`, `parent_letter_id`, `proposal_id`, `valence`, `user_id`, `body`, `score`, `title`) VALUES (1,'2014-07-13 17:02:17','2014-08-29 18:05:03',NULL,1,-1,2,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',6,'Petition Title'),(14,'2014-07-13 17:02:17','2014-08-29 18:03:16',NULL,1,0,2,'A new letter!',2,'Petition Title'),(16,'2014-07-13 17:02:17','2014-08-29 18:06:43',NULL,1,1,2,'aoeu',2,'Petition Title'),(38,'2014-07-13 17:02:17','2014-08-29 18:03:16',14,1,0,1,'A new letter!',1,'Petition Title'),(39,'2014-07-13 17:02:17','2014-08-29 18:03:16',1,1,-1,1,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',1,'Petition Title'),(40,'2014-07-13 17:02:17','2014-08-29 18:03:17',NULL,1,1,1,'Wadatay',1,'Petition Title'),(41,'2014-07-13 17:02:17','2014-08-29 18:03:17',1,1,-1,1,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',1,'Petition Title'),(42,'2014-07-13 17:02:17','2014-08-29 18:03:17',1,1,-1,1,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',1,'Petition Title'),(43,'2014-07-13 17:02:17','2014-08-29 18:03:17',1,1,-1,1,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',1,'Petition Title'),(44,'2014-07-13 17:02:17','2014-08-29 18:03:17',16,1,1,1,'aoeu',1,'Petition Title'),(45,'2014-07-13 17:02:17','2014-08-29 18:03:17',1,1,-1,1,'I do not support the project to expand the Keystone Pipeline System.  This proposal generates serious and certain  environmental losses, which do not justify the economic gains.  Furthermore, the development will bring wealth mainly to foreign shareholders, so that the actual economic gains will be much less than they should  be.',1,'Petition Title');
...
--
-- Dumping data for table `digidemo_proposal_sectors`
--
...
REPLACE INTO `digidemo_proposal_tags` (`id`, `proposal_id`, `tag_id`) VALUES (1,1,63),(2,4,62);
...
REPLACE INTO `digidemo_proposalversion_tags` (`id`, `proposalversion_id`, `tag_id`) VALUES (1,37,62),(2,39,63),(3,39,64),(4,39,65),(5,40,63),(6,40,64),(7,40,65),(8,41,63);
...
-- Dump completed on 2014-08-30  1:59:49
